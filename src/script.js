...
(function createPage() {
    ...
    let mainContent
    const header = `<div class="header"><h1>Veggiewiches</h1><div class='menu'><ul><li id='home'> <a href="">Home</a></li> <li id='menu'><a href="">Menu</a></li><li id='contact'><a href="">Contact</a></li></ul></div></div>`;
